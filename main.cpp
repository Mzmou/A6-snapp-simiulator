...
template <typename T>
void DataBase :: add_mission(T)
{
    total_mission.push_back(T());
}
...
int main()
{
    ...
    while (cin >> command)
    {
        ...
        {
            cout <<new_database.total_mission[i]->get_mission_id() << '\n';
            cout <<new_database.total_mission[i]->get_start_time_stamp() << '\n';
